...
export default function RegisterPage() {
  ...
  const handleBulkUpload = async () => {
    ...
    if (newStudents.length === 0) {
      alert('유효한 데이터가 없습니다. (이름, 학교, 학년, 전화번호 뒷 4자리 순서인지 확인해주세요)');
      return;
    }
      ...
      <div className="grid-cols-2" style={{ gap: '30px' }}>
        ...
        <div>
          ...
          <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '10px' }}>
            엑셀에서 <b>[이름, 학교, 학년, 전화번호 뒷 4자리]</b> 열을 선택 후 복사하여 아래에 붙여넣어 주세요. (이름 | 학교 | 1학년 | 1234)
          </p>
          <div className="form-group">
            <textarea 
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '10px' }}>
            <thead>
              <tr style={{ background: '#f3f4f6', borderBottom: '2px solid #e5e7eb', textAlign: 'left' }}>
                ...
                <th style={{ padding: '12px', color: '#4b5563' }}>전화번호 뒷 4자리</th>
